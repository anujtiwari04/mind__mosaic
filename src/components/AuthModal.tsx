...
//       <div className="fixed inset-0 bg-black bg-opacity-50"></div>
//       <div className="flex min-h-full items-center justify-center p-4">
//         <div className="relative bg-white dark:bg-gray-800 rounded-xl w-full max-w-md p-6">
//           <div className="mb-6">
...
//                   value={username}
//                   onChange={(e) => setUsername(e.target.value)}
//                   className="w-full p-3 text-white rounded-lg bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 focus:ring-2 focus:ring-emerald-500 dark:focus:ring-emerald-400"
//                   placeholder="Enter your username"
//                   required
//                 />
//               </div>
